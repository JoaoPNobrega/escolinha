...
serve(async (req) => {
  ...
  try {
    ...
    // Aplicar correção UTF-8 e valores padrão com a nova paleta
    ...
    const themeColor = config.theme_color || '#FF8C00'   // DarkOrange
    const backgroundColor = config.background_color || '#708090' // SlateGrey
